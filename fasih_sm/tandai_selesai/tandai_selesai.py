...
LANGKAH
-------
    python fasih_sm/tandai_selesai/tandai_selesai.py --semua --console
    python fasih_sm/tandai_selesai/tandai_selesai.py --daftar daftar_buka_wilayah.txt --console
...
from fasih_sm.buka_wilayah.buka_wilayah import PENANDA_KODE_KAB, baca_daftar  # noqa: E402 — format daftar sama persis
...
KONSOL_SIAP = lokasi.hasil("fasih_sm", "tandai_selesai") / "tandai_selesai_console.siap.js"
...
def tulis_console(kode, semua: bool) -> Path:
    ...
    lokasi.siapkan(KONSOL_SIAP).write_text(isi_template(teks, kode, semua), encoding="utf-8")
    return KONSOL_SIAP
