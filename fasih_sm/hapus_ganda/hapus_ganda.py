...
dokumen — lalu menyuntikkannya ke fasih_sm/hapus_ganda/hapus_ganda_console.js ->
...
bernama sama — lihat daftar_ganda.csv dan putuskan manual.
    ...
    python fasih_sm/hapus_ganda/hapus_ganda.py --akun ppl.contoh@gmail.com     # hanya grup akun ini

SESUDAH menghapus (hapusGanda.unduh() -> ganda_dihapus_*.csv di folder proyek):

    python fasih_sm/hapus_ganda/hapus_ganda.py --catat           # lihat rencananya
    python fasih_sm/hapus_ganda/hapus_ganda.py --catat --tulis   # tulis ke audit_log_gabungan.csv
...
Tutorial: fasih_sm/hapus_ganda/README.md.
"""
...
from input_usaha.sinkron_list import url_entry  # noqa: E402
...
KONSOL_SIAP = lokasi.hasil("fasih_sm", "hapus_ganda") / "hapus_ganda_console.siap.js"
...
def main(argv=None) -> int:
    ...
    print("Tutorial: fasih_sm/hapus_ganda/README.md")
    return 0
