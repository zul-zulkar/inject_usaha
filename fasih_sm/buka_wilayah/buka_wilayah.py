...
LANGKAH
-------
    python fasih_sm/buka_wilayah/buka_wilayah.py --semua --console
    python fasih_sm/buka_wilayah/buka_wilayah.py --daftar daftar_buka_wilayah.txt --console
...
KONSOL_SIAP = lokasi.hasil("fasih_sm", "buka_wilayah") / "buka_wilayah_console.siap.js"
