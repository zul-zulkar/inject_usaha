...
Alur lama dua tahap (petakan -> cek -> eksekusi) tetap ada, lihat fasih_sm/pindah_wilayah/README.md.

FORMAT TAHAP 2 (hasil pendataan kertas, bahan/input_usaha.xlsx)
---------------------------------------------------------------
Format bawaan (tahap 2). Tujuan = kolom "5" sheet; target HANYA baris yang
...
lain: jalankan dulu `input_usaha/sinkron_list.py ... --tulis`.
    python approve_pml/approve_pml.py --akun-pml <PML> --akun-ppl <PPL> --eksekusi   (approve dulu)
    python fasih_sm/pindah_wilayah/pindah_wilayah.py --sumber bahan/input_usaha.xlsx \
        --dari-approve --daftar-tujuan tujuan_tahap2.txt --console
    python fasih_sm/buka_wilayah/buka_wilayah.py --daftar tujuan_tahap2.txt --console      (kalau tujuan Listing Selesai)
"""
...
from input_usaha.sinkron_list import id_dari_url, norm
...
KONSOL_SIAP = lokasi.hasil("fasih_sm", "pindah_wilayah") / "pindah_wilayah_console.siap.js"
AUDIT_APPROVE_PATH = lokasi.AUDIT_APPROVE
